...
namespace CommonCode
{
    ...
    public class ObservableList<T> : List<T>, ICollection<T>, INotifyCollectionChanged, INotifyPropertyChanged, IDeserializationCallback
    {
        ...
        private bool _collectionChangedNotificationsDisabled = false;
        protected void DisableCollectionChangedNotifications() { _collectionChangedNotificationsDisabled = true; }
        protected void EnableCollectionChangedNotifications() { _collectionChangedNotificationsDisabled = false; }
        protected virtual void OnCollectionChanged(NotifyCollectionChangedEventArgs e)
        {
            if (_collectionChangedNotificationsDisabled) return;
